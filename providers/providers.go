...
func NewProvider(providerConfig options.Provider) (Provider, error) {
	...
	case options.CivoProvider:
		return NewCivoProvider(providerData, providerConfig.CivoConfig), nil
...
func providerRequiresOIDCProviderVerifier(providerType options.ProviderType) (bool, error) {
	switch providerType {
	case options.BitbucketProvider, options.CivoProvider, options.DigitalOceanProvider, options.FacebookProvider, options.GitHubProvider,
